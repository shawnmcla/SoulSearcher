import { getRandomSeed } from './SoulSearcher.js';
...
`;
    ...
    document.querySelector('#randomseed').addEventListener('click', (e) => {
        console.log(e);
        const seedInput = document.querySelector('#seed').value = getRandomSeed();
    });
